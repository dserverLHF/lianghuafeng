...
def alipay_url():
    ...
    alipay = AliPay(
        appid="2016031001199224",
        app_notify_url="http://czw96.me:8000/alipay_verify/",
        app_private_key_path="L:/flask_alipay/keys/rsa_private_key.pem",
        alipay_public_key_path="L:/flask_alipay/keys/alipay_key.txt",  # 支付宝的公钥，验证支付宝回传消息使用，不是你自己的公钥,
        debug=True,  # 默认False,
        return_url="http://www.callkin.com/",
...
if __name__ == "__main__":
    ...
    # alipay = AliPay(
    #     appid="2016031001199224",
    #     app_notify_url="http://www.callkin.com/",
    #     app_private_key_path="../keys/rsa_private_key.pem",
    #     alipay_public_key_path="../keys/alipay_key.txt",  # 支付宝的公钥，验证支付宝回传消息使用，不是你自己的公钥,
    #     debug=True,  # 默认False,
    #     return_url="http://www.callkin.com/",
    #
    # )
    ...
    # url = alipay.direct_pay(
    #     subject="报名费用",
    #     out_trade_no="20180200sss",
    #     total_amount=0.01,
    #     return_url="http://www.callkin.com/",
    #     notify_url="localhost:5000/alipay_verify/" # 支付宝支付验证
    # )
    # re_url = "https://openapi.alipay.com/gateway.do?{data}".format(data=url)
    #
    # print(re_url)